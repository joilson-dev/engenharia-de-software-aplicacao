...
//Retorno do root
function getRoot() {
    var root = "http://" + document.location.hostname + "/cadastro_login/";
    return root;
}
...
function getCaptcha() {
    grecaptcha.ready(function () {
        grecaptcha.execute('6Le5fW4aAAAAAC3ZN0k1POpSTFfA7bwyGQoV-SfI', { action: 'homepage' }).then(function (token) {
